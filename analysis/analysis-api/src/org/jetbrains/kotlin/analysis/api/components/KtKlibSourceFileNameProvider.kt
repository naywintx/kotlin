...
public abstract class KtKlibSourceFileNameProvider : KtAnalysisSessionComponent() {
    public abstract fun getKlibSourceFileName(declaration: KtDeclarationSymbol): KtSourceFileName?
}
...
public interface KtKlibSourceFileProviderMixIn : KtAnalysisSessionMixIn {
     ...
     */
    public fun KtDeclarationSymbol.getKlibSourceFileName(): KtSourceFileName? =
