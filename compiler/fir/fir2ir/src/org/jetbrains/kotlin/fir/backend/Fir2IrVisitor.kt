        ...
        return binaryLogicExpression.convertWithOffsets<IrElement> { startOffset, endOffset ->
            ...
            if (leftOperand.type is IrDynamicType) {
                ...
                LogicOperationKind.AND -> {
                    IrWhenImpl(startOffset, endOffset, irBuiltIns.booleanType, IrStatementOrigin.ANDAND).apply {
                ...
                LogicOperationKind.OR -> {
                    IrWhenImpl(startOffset, endOffset, irBuiltIns.booleanType, IrStatementOrigin.OROR).apply {
