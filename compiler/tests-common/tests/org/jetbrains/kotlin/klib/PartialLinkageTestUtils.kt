...
object PartialLinkageTestUtils {
    ...
    fun runTest(
        ...
        compilerVersionMutation: KlibCompilerChangeScenario = KlibCompilerChangeScenario.Base,
    ) =
        with(testConfiguration) {
            ...
            projectInfo.steps.forEach { projectStep ->
                projectStep.order.forEach { moduleName ->
                    ...
                    val compilerVersion = when (moduleStep.compiler) {
                        ModuleInfo.CompilerCase.BOTTOM_V1 -> compilerVersionMutation.bottomV1
                        ModuleInfo.CompilerCase.BOTTOM_V2 -> compilerVersionMutation.bottomV2
                        ModuleInfo.CompilerCase.INTERMEDIATE -> compilerVersionMutation.intermediate
