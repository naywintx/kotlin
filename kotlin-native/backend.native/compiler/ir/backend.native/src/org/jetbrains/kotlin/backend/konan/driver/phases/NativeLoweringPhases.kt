...
private fun PhaseEngine<NativeGenerationState>.getAllLowerings() = listOfNotNull<AbstractNamedCompilerPhase<NativeGenerationState, IrFile, IrFile>>(
        ...
        assertsRemovalPhase.takeUnless { context.config.configuration.getBoolean(NativeConfigurationKeys.ENABLE_ASSERTIONS) },
        ...
        testProcessorPhase.takeIf { context.get(NativeConfigurationKeys.GENERATE_TEST_RUNNER) != TestRunnerKind.NONE },
        delegationPhase,
