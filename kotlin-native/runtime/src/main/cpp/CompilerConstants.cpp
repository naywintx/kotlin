...
RUNTIME_WEAK uint32_t Kotlin_profilersBacktraceDepth[] = {0};
...
ALWAYS_INLINE uint32_t* compiler::profilersBacktraceDepth() noexcept {
    return Kotlin_profilersBacktraceDepth;
}
