...
internal interface XcodeEnvironment {
    ...
    companion object {
        ...
        fun environment(project: Project): XcodeEnvironment {
            return project.extraProperties.getOrNull(XCODE_ENVIRONMENT_KEY) as? XcodeEnvironment ?: AppleXcodeEnvironment()
        }
    }
}
