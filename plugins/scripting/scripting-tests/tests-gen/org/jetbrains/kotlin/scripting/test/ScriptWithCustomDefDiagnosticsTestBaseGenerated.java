...
public class ScriptWithCustomDefDiagnosticsTestBaseGenerated extends AbstractScriptWithCustomDefDiagnosticsTestBase {
    @Test
    public void testAllFilesPresentInTestScripts() throws Exception {
    ...
    public void testConflictingImportsWithJava_test() throws Exception {
    ...
    public void testProvidedPropertiesShadowing_test() throws Exception {
